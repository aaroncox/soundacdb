...
class WitnessController extends ControllerBase
{
  ...
  public function forwardAction() {
    $id = strtolower($this->dispatcher->getParam("id"));
    $witness = Witness::findFirst(['id' => $id]);
    return $this->response->redirect('/@'.$witness->account);
    var_dump($id, $witness); exit;
  }
}
