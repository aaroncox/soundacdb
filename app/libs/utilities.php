...
class Utilities
{
  ...
  public function distribution($props) {
    ...
    $totals = [
      'curation' => 0,
      'authors' => 0,
      'interest' => $this->di->get('convert')->sp2vest($props['virtual_supply'] * 0.095 * 0.15 / 30, false),
      'witnesses' => $this->di->get('convert')->sp2vest($props['virtual_supply'] * 0.095 * 0.1 / 30, false),
    ];
    // Set Date Range
