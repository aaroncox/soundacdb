    ...
    <div class="row">
      <div class="twelve wide column" id="main-context">
        ...
        <div class="ui attached segment">
          <svg width="100%" height="0px" id="account-{{ router.getActionName() }}"></svg>
        </div>
        {% endif %}
            ...
            <tbody>
              <tr>
                ...
                <td class="right aligned">
                  <?php echo number_format($account->balance, 6, '.', ','); ?>
                </td>
              </tr>
              <tr>
                <td>xUSD</td>
                <td class="right aligned">
                  <?php echo number_format($account->mbd_balance, 6, '.', ','); ?>
                </td>
              </tr>              <tr>
                <td>MUSIC POWER</td>
                <td class="right aligned">
                  <?php echo number_format($account->vesting_shares, 6, '.', ','); ?>
                </td>
              </tr>
